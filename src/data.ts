...
export const CARD_DATA: Map<CardName, Card>  = new Map([
    ...
    { name: CardName.SERVAZOA,          type: CardType.MECH,    culture_clash: true,    cost: 3, prod: 2, 					roll: 2 as const, 		qty: 3,                         desc: "Once per turn, if you cycle, get 1 credit." },
    ...
    { name: CardName.SELACHONID,        type: CardType.BIO,     culture_clash: true,    cost: 4, prod: 0,                	roll: 5 as const, 		qty: 3,                         desc: "Once per turn, Discard one of your cards. Selachonid gets +2 production." },
    ...
    { name: CardName.ZYGATE_INTERCHANGE,type: CardType.BIO,     culture_clash: true,    cost: 3, prod: 1, 					roll: 6 as const, 		qty: 3, type2: CardType.SPIRIT, desc: "+2 production if you have 7 different roll values." },
    { name: CardName.STARFIELD_WALKER,  type: CardType.BIO,     culture_clash: true,    cost: 8, prod: 5, 					roll: 7 as const, 		qty: 3 },
    { name: CardName.THE_SPIRE,         type: CardType.SPIRIT,  culture_clash: true,    cost: 5, prod: 2, 					roll: 7 as const, 		qty: 3, type2: CardType.MECH,   desc: "+2 production if you have 2 Bio cards." },
    ...
    { name: CardName.PLANAR_SHEPARD,    type: CardType.SPIRIT,  culture_clash: true,    cost: 5, prod: 2, 					roll: 8 as const, 		qty: 3,                         desc: "If a Bio produced for you this production roll, get 1 credit." },
